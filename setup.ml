...
(* OASIS_START *)
(* DO NOT EDIT (digest: 02ad3fb96bc1c53980a1a953371e2870) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("core_kernel",
                               Some (OASISVersion.VGreaterEqual "108.08.00"));
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "E\157\144\233\179\003\1342\004L\245c6\178h\018";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
